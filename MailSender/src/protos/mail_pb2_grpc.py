...
from protos import mail_pb2 as mail__pb2
from protos import mail_pb2 as mail__pb2
...
class MailServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckBounceStatus = channel.unary_unary(
                '/mail.MailService/CheckBounceStatus',
                request_serializer=mail__pb2.BounceRequest.SerializeToString,
                response_deserializer=mail__pb2.BounceResponse.FromString,
                _registered_method=True)
...
def add_MailServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckBounceStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckBounceStatus,
                    request_deserializer=mail__pb2.BounceRequest.FromString,
                    response_serializer=mail__pb2.BounceResponse.SerializeToString,
            ),
    }
...
class MailService(object):
    ...
    def CheckBounceStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/mail.MailService/CheckBounceStatus',
            mail__pb2.BounceRequest.SerializeToString,
            mail__pb2.BounceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
